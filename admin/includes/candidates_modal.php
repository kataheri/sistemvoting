        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="`group`" class="col-sm-3 control-label">Kelompok</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="edit_group" class="col-sm-3 control-label">Kelompok</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="edit_group" name="group" required>
                        <option value="" selected id="groupselect" hidden></option>
                        <?php
                          $sql = "SELECT * FROM  `group`";
                          $query = $conn->query($sql);
                          while($row = $query->fetch_assoc()){
